              ...
              {showRAM === true && (
                <Row className="sp-form-row">
                  ...
                  <Col sm={7}>
                    <Form.Select
                      value={
                        this.state.selectedRAM ||
                        this.state.fData.contextData.defaultRAM
                      }
                      name="ram"
                      className="sp-form-cursor"
                      onChange={this.handleRAMChange.bind(this)}
                    >
                      {this.state.fData.contextData.availableRAM.map(
                        (mapObj) => (
                  ...
                  <Col sm={7}>
                    <Form.Select
                      ...
                      value={
                        ...
                        this.state.fData.contextData.defaultCores
                      }
                      onChange={this.handleCoresChange.bind(this)}
                    >
                      {this.state.fData.contextData.availableCores.map(
                        (mapObj) => (
                          <option key={mapObj} value={mapObj}>
                            {mapObj}
                          </option>
